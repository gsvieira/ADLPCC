...
# CUDA_VISIBLE_DEVICES=0 python ../ADLPCC/src/ADLPCC.py train "/home/valeska/MPEG_Down/Training/*.ply" "../Training/Experiment_0/5000/0.9/" --last_step 50000 --lambda 5000 --fl_alpha 0.9